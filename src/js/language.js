const AllTexts = {
  "en": {
    ...
    qLearning: {
      ...
      text: `Für mich ist es praktischer, die sogenannten Q-Werte statt die V-Werte zu aktualisieren. Die Q-Werte zeigen eine zu erwartende langfristige Belohnung, wenn ich in einem Zustand bin und eine gewisse Aktion wähle. Sie ist also nicht nur vom Zustand abhängig, sondern auch von der Aktion. Der Vorteil ist, dass ich einfacher entscheiden kann, welche Aktion die beste ist (diejenige mit dem höchsten Q-Wert) und ich kann so theoretisch auch in nicht-deterministische Umgebungen lernen. Nicht-deterministisch heißt, dass meine Bewegungen eine gewisse Wahrscheinlichkeit in sich tragen. Ich würde etwa mit derselben Aktion in einem gewissen Zustand nicht immer im selben Folgezustand landen.<br>
      <br>
      Es wurde (mathematisch) bewiesen, dass Q-Learning für jedes Problem zur optimalen Strategie (die am besten die Belohnungen maximiert) - zumindest bei bestimmten Bedingungen und einer seeehr langen Lernzeit. Das ist fantastisch! Eine Methode, um alle Probleme zu lösen, für jedes beliebige Labyrinth! Oder für andere Spiele (mit Zuständen, Aktionen und Belohnungen)...<br>
      <br>
